...
export default function Footer() {
  const links = [
    ...
    {
      title: 'LeetCode',
      url: 'https://leetcode.com/u/Gangadharan09/',
      icon: 'ri-code-line',
    },
    {
      title: 'GitHub',
      url: 'https://github.com/GangadharanKannan/',
      icon: 'ri-github-line',
    },
    {
      title: 'linkedin',
      url: 'https://www.linkedin.com/in/gangadharan-k-a2b121281',
      icon: 'ri-linkedin-line',
    },
    {
      title: 'Instagram',
      url: 'https://www.instagram.com/mr_gd_0904/',
